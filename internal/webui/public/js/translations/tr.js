...
window.translations.tr = {
    ...
    // Özel Uç Noktalar ve Yönlendirme
    customEndpoints: "Şeffaf Yönlendirme (Özel Uç Noktalar)",
    customEndpointsDesc: "Belirli model isteklerini Google dönüşümünü atlayarak doğrudan Anthropic uyumlu özel uç noktalara yönlendirin.",
    addEndpoint: "Uç Nokta Ekle",
    editEndpoint: "Özel Uç Noktayı Düzenle",
    deleteEndpoint: "Uç Noktayı Sil",
    endpointUrl: "Hedef Uç Nokta URL'si",
    apiKey: "API Anahtarı / Token (İsteğe bağlı)",
    keyConfigured: "Anahtar Yapılandırıldı",
    noKey: "Anahtar Yok",
    noEndpointsConfigured: "YAPILANDIRILMIŞ ÖZEL YÖNLENDİRME UÇ NOKTASI YOK",
    endpointModalDesc: "Bu model için harici bir Anthropic uyumlu API uç noktası yapılandırın.",
    modelIdRequired: "Model ID zorunludur",
    urlRequired: "Uç Nokta URL'si zorunludur",
    endpointSavedSuccess: "Özel uç nokta başarıyla kaydedildi",
    endpointDeletedSuccess: "Özel uç nokta başarıyla silindi",
    confirmDeleteEndpoint: "Bu özel uç noktayı kaldırmak istediğinizden emin misiniz?",
    failedToSaveEndpoint: "Özel uç nokta kaydedilemedi",
    failedToDeleteEndpoint: "Özel uç nokta silinemedi",
    authStatus: "Kimlik Doğrulama",
    familyForwarded: "Yönlendirilen / Özel",
    forwardedBadge: "Yönlendirildi",
    // Model Takma Adları
    addAlias: "Model Takma Adı Ekle",
    addAliasDesc: "Gelen model isteğini hedef model ID'sine yönlendirin.",
    sourceModel: "Kaynak Model ID (Gelen)",
    targetModel: "Hedef Model ID",
    sourceModelRequired: "Kaynak Model ID zorunludur",
    targetModelRequired: "Hedef Model ID zorunludur",
    aliasSavedSuccess: "Model takma adı başarıyla kaydedildi",
    aliasDeletedSuccess: "Model takma adı başarıyla silindi",
    confirmDeleteAlias: "Bu model takma adını kaldırmak istediğinizden emin misiniz?",
    failedToDeleteModelAlias: "Model takma adı silinemedi",
    aliasBadge: "Takma Ad",
    deleteAlias: "Takma Adı Sil",
    // OpenRouter Gateway & Discovery
    openRouterGateway: "OpenRouter Ağ Geçidi & Anthropic Skin",
    openRouterDesc: "İzin verilen modelleri doğrudan OpenRouter Anthropic Skin uç noktasına SSE akışıyla şeffaf bir şekilde yönlendirin.",
    openRouterBaseUrl: "Temel URL",
    openRouterApiKey: "API Anahtarı",
    discoverModels: "Modelleri Keşfet",
    openRouterAllowlist: "İzin Verilen Modeller ve Takma Adlar",
    discoverModalTitle: "OpenRouter Modellerini Keşfet",
    searchModelsPlaceholder: "Modelleri ada, ID'ye veya açıklamaya göre arayın...",
    openRouterSavedSuccess: "OpenRouter ayarları başarıyla kaydedildi",
    confirmRemoveAllowlist: "{modelId} izin listesinden kaldırılsın mı?",
    ...
    // OpenRouter allowlist tablosu ve sağlayıcı yönlendirme paneli
    save: "Kaydet",
    remove: "Kaldır",
    alias: "Takma Ad",
    localAlias: "Yerel Takma Ad",
    loading: "Yükleniyor...",
    contextLength: "Bağlam",
    providerRouting: "Sağlayıcı Yönlendirmesi",
    provider: "Sağlayıcı",
    ...
    presetHint: "Yüklemek için bir ön ayar seçin. Değişiklikleri kaydetmek için \"Claude CLI'ye Uygula\"ya tıklayın.",
    unsavedChangesTitle: "Kaydedilmemiş Değişiklikler",
    unsavedChangesMessage: "Mevcut yapılandırmanız kayıtlı bir ön ayarla eşleşmiyor. Değiştirirseniz, kaydedilmemiş ayarlarınız kaybolur.",
    loadAnyway: "Yine de Yükle",
    savePresetTitle: "Ön Ayarı Kaydet",
    savePresetDesc: "Mevcut yapılandırmayı yeniden kullanılabilir bir ön ayar olarak kaydeder.",
    presetName: "Ön Ayar Adı",
    presetNamePlaceholder: "örn. İş Kurulumum",
    savePreset: "Ön Ayarı Kaydet",

    // Headroom Motoru
    headroomSettings: "Headroom Bağlam Optimizasyonu",
    headroomDesc: "Yerel bağlam sıkıştırma, boşluk budama, çıktı şekillendirme ve içerik koşullu erişim (CCR).",
    headroomEnabled: "Headroom Motorunu Etkinleştir",
    ...
    headroomLiveTurnsDesc: "Alma parçalaması yapılmadan satır içi tutulan en son mesaj turu sayısı.",
    headroomOutputShaper: "Output Shaper (Çıktı Şekillendirici)",
    headroomOutputShaperDesc: "Hassas yönlendirme istemi ekler ve mekanik araç turlarında düşünme bütçesini sınırlar.",
    headroomVerbositySteering: "Ayrıntı Düzeyi Yönlendirme",
    headroomVerbositySteeringDesc: "Modelleri gereksiz açıklamalardan kaçınarak özlü teknik çıktılar üretmeye yönlendirir.",
    headroomSteeringText: "Özel Yönlendirme İstemi",
    headroomSteeringTextPlaceholder: "Varsayılan özlü teknik istemi kullanmak için boş bırakın",
    headroomEffortRouting: "Düşünme Çabası Yönlendirmesi",
    headroomEffortRoutingDesc: "Mekanik araç devamlarında düşünme bütçesini sınırlandırır.",
    headroomThinkingBudget: "Mekanik Düşünme Bütçesi",
    headroomCcr: "İçerik Koşullu Erişim (CCR)",
    headroomCcrDesc: "Büyük araç çıktılarını parça deposuna aktarır ve dinamik olarak alır (yalnızca Cloud Code ve OpenRouter).",
    headroomCcrEnabled: "CCR İndirgemesini Etkinleştir",
    headroomMaxStoreMB: "Maks Depo Boyutu (MB)",
    headroomMinChunkBytes: "Min Parça Boyutu (Bayt)",
    headroomStatsTitle: "Headroom Sıkıştırması",
    headroomBytesSaved: "Tasarruf Edilen Bayt",
    ...
    commandCrusherRequiresEngine: "Yukarıdaki Headroom Motorunun etkinleştirilmesini gerektirir.",
    commandCrusherToolsTitle: "Desteklenen Araçlar ve Çalıştırıcılar",
    commandCrusherSafetyTitle: "Güvenlik Garantileri",
    commandCrusherSafetyDesc: "Araç hataları (is_error: true), test başarısızlıkları, yığın izleri ve tam dosya okumaları (etkinleştirildiğinde) kesinlikle korunur.",
