...
window.translations.id = {
    ...
    commandCrusherRequiresEngine: "Memerlukan Mesin Headroom diaktifkan di atas.",
    commandCrusherToolsTitle: "Alat & Pelari yang Didukung",
    commandCrusherSafetyTitle: "Jaminan Keamanan",
    commandCrusherSafetyDesc: "Kesalahan alat (is_error: true), kegagalan uji, traceback, dan pembacaan file verbatim (jika diaktifkan) dipertahankan utuh.",
